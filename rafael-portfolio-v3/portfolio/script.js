...
const i18n = {
  pt: {
    ...
    case1d:'Condução da migração de toda a camada de dashboards e indicadores para uma nova estrutura analítica, preservando a leitura executiva e eliminando a dependência de uma ferramenta com custo mensal elevado. A mudança gerou uma economia recorrente significativa no orçamento de tecnologia, com impacto direto no resultado da operação.',
    case1i:'&#8599; Economia recorrente significativa no orçamento de tecnologia',
    ...
    t1p:'2025 · atual', t1t:'Analista de Dados', t1d:'Atuação com análise de performance, dashboards executivos, métricas, SQL, automação de relatórios e leituras conectadas à operação e aos clientes.',
    ...
    t2p:'2024 · 2025', t2t:'Estagiário em BI', t2d:'Base forte em organização de dados, construção de relatórios, visualização e apoio analítico a projetos de negócio e performance.',
    t3p:'2026 · atual', t3t:'Cofundador · Dados, BI e inteligência operacional', t3d:'Estruturação da camada analítica da operação com foco em indicadores, dashboards, leitura de performance e integração com soluções de automação.',
    t4p:'Experiência anterior', t4t:'Assistente de Operações', t4d:'Atuação multidisciplinar em operações, suporte, dados e relacionamento, com contato direto com entregadores, restaurantes e consumidores finais.',
    t4l1:'Suporte e helpdesk para entregadores, restaurantes e consumidores do app.', t4l2:'Dashboards no Looker Studio para acompanhamento operacional nas três frentes.', t4l3:'Prevenção de churn via escuta ativa e quebra de objeções com donos de restaurantes.', t4l4:'Automação de disparos para prospecção de novos entregadores na plataforma.', t4l5:'Atuação em prevenção de fraudes.',
  ...
  en: {
    ...
    case1d:'Led the migration of the entire dashboard and indicator layer to a new analytical structure, preserving executive readability while eliminating dependency on a high-cost tool. The change generated significant recurring savings in the technology budget, with direct impact on operational results.',
    ...
    t1p:'2025 · present', t1t:'Data Analyst', t1d:'Working with performance analysis, executive dashboards, metrics, SQL, report automation and insights connected to operations and clients.',
    ...
    t2p:'2024 · 2025', t2t:'BI Intern', t2d:'Strong foundation in data organization, report building, visualization and analytical support for business and performance projects.',
    t3p:'2026 · present', t3t:'Co-founder · Data, BI and operational intelligence', t3d:'Structuring the analytical layer of operations with focus on indicators, dashboards, performance readings and integration with automation solutions.',
    t4p:'Previous experience', t4t:'Operations Assistant', t4d:'Multidisciplinary role in operations, support, data and customer relationships, with direct contact with delivery drivers, restaurants and end consumers.',
    t4l1:'Support and helpdesk for drivers, restaurants and app consumers.', t4l2:'Looker Studio dashboards for operational monitoring across all three fronts.', t4l3:'Churn prevention through active listening and objection handling with restaurant owners.', t4l4:'Automated outreach for prospecting new drivers on the platform.', t4l5:'Fraud prevention.',
